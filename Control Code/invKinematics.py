...
def eqnX(q1, q2, x):
    return 0.155*math.cos(q1+q2)+0.135*math.cos(q1)-x

def eqnZ(q1, q2, y):
    return 0.155*math.sin(q1+q2)+0.135*math.sin(q1)-y
...
def invKinematic(x,y,z,q1,q2):
    newQ1, newQ2 = solve(eqnX, eqnZ, q1, q2, x, y, 0.01)
    return newQ1, newQ2
